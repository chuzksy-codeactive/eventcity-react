          ...
          <Fragment key={i}>
            {isDeleted && editable ? (
              <div className="is-deleted">
                This center was deleted by the admin. Please book another event
              </div>
            ) : null}
            <div key={event.id} className={deletedStyle}>
              ...
              <div
                className=" btn btn-danger btn-list ion-icon"
                data-toggle="tooltip"
              ...
              >
                <i
                  ...
                  onClick={this.onOpenModalDelete.bind(this, event.id)}
                />
              </div>{" "}
              <div
            ...
            {!isDeleted &&
              event.Center && (
                <div className="collapse" id={event.name} key={event.name}>
                    ...
                    <div className="wrap-item-details">
                      <div id="img">
                        <img
                          ...
                          src={event.Center.imageUrl}
                          alt={`${event.Center.name} image`}
                        />
                      </div>
