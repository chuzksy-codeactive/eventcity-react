      ...
      <div className="testimonials container">
        <div className="testimony">
          <blockquote>
            ...
            <cite>
              <img src="https://res.cloudinary.com/dcgwltbei/image/upload/v1530624111/customer1.jpg" alt="testimonial" />Okwarazoro Austin
            </cite>
          </blockquote>
        </div>
        <div className="testimony">
          <blockquote>
            ...
            <cite>
              <img src="https://res.cloudinary.com/dcgwltbei/image/upload/v1530624111/customer2.jpg" alt="testimonial" />Oguntimehim Posi
            </cite>
          </blockquote>
        </div>
        <div className="testimony">
          <blockquote>
            ...
            <cite>
              <img src="https://res.cloudinary.com/dcgwltbei/image/upload/v1530624112/customer3.jpg" alt="testimonial" />Adekunle Shina
            </cite>
          </blockquote>
        </div>
      </div>
